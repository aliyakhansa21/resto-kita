import { CheckoutSession, PaymentMethod } from "@/types";
...
export function OrderDetail({ session, paymentMethod, onBack }: Props) {
    ...
    const items = session.orders.flatMap((o) => o.order_items);
    ...
    return (
        ...
        >
            ...
            <p
                ...
                isCash ? "text-[#92400E]" : "text-green-700"
                }`}
            >
                {isCash ? "Waiting for Payment" : "Payment Successful"}
            </p>
            <p 
                className={`text-text-sm mt-1 ${
                isCash ? "text-[#B45309CC]" : "text-green-700"}`}
            >
                {isCash
        ...
        <section className="px-6 py-5 border-secondary-20">
            ...
            <div
                ...
                !isCash ? "border-b border-secondary-20" : ""
                }`}
            >
                <span className="text-text-xs font-semibold text-secondary-50 uppercase tracking-wider">
                Method
        ...
        <section className="px-6 py-5 border-secondary-20">
            ...
            <div className="border-secondary-20 pt-4 mt-3 flex flex-col gap-2">
                ...
                <div className="flex justify-between font-black text-h4 text-primary-50 border-secondary-20 pt-3 mt-1">
