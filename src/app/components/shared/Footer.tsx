...
import { Mail, Instagram, Phone, Utensils } from "lucide-react";

export function Footer() {
    return (
        <footer className="bg-[#3E2723] text-stone-400 px-6 py-10">
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start justify-between gap-8">
                ...
                <div className="max-w-xs">
                    ...
                    <p className="text-xs text-secondary leading-relaxed">
                        Elevating your dining experience with every single plate we serve.
                    </p>
                </div>
                ...
                <a href="mailto:hello@ourrestaurant.com" aria-label="Email" className="hover:text-white transition-colors">
                    <Mail size={18} />
                </a>
                ...
                <a href="https://wa.me/62xxx" target="_blank" rel="noreferrer" aria-label="WhatsApp" className="hover:text-white transition-colors">
                ...
                <a href="tel:+62xxx" aria-label="Phone" className="hover:text-white transition-colors">
                    <Phone size={18} />
                </a>
                </div>
            </div>
            ...
            <p className="text-center text-xs text-stone-600 mt-8">
                © 2026 Our Restaurant Group. All Right Reserved.
            </p>
        </footer>
    );
}